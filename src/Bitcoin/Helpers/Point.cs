...
namespace Helpers
{
    public class Point
    {
        public static Point INFINITY = new Point(null, default(BigInteger), default(BigInteger));
        ...
        public Point Double()
        {
            ...
            var p = this.Curve.p;
            var a = this.Curve.a;
            var l = ((3 * this.X * this.X + a) * InverseMod(2 * this.Y, p)) % p;
            var x3 = (l * l - 2 * this.X) % p;
            var y3 = (l * (this.X - x3) - this.Y) % p;
        ...
        private static BigInteger InverseMod(BigInteger a, BigInteger m)
        {
            ...
            {
                //q, c, d = divmod( d, c ) + ( c, );
                var q = BigInteger.DivRem(d, c, out BigInteger r);
                d = c;
                c = r;
